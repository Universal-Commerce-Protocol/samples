...
public class DiscountRequest {
  ...
  public DiscountRequest codes(List<String> codes) {
    this.codes = codes;
    return this;
  }
  ...
  public static class Builder {
    ...
    public DiscountRequest.Builder codes(List<String> codes) {
      this.instance.codes(codes);
      return this;
    }
    
    public DiscountRequest.Builder applied(List<DiscountRequestAppliedInner> applied) {
