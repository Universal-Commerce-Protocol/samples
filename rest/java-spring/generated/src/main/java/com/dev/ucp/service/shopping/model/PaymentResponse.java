...
public class PaymentResponse {
  ...
  public PaymentResponse instruments(List<CardPaymentInstrument> instruments) {
  ...
  public static class Builder {
    ...
    public PaymentResponse.Builder handlers(List<PaymentHandlerResponse> handlers) {
    ...
    public PaymentResponse.Builder instruments(List<CardPaymentInstrument> instruments) {
