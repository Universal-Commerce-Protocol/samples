...
/**
 * Exception thrown when an idempotency key is reused with a different request payload, indicating a
 * conflict that prevents the server from processing the request.
 *
